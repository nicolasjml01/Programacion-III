    ...
    public static void main(String[] args) throws Exception {
        ...
        if (persona1.getHeightMeters() >= persona2.getHeightMeters()){
            if (persona1.getHeightMeters() >= persona3.getHeightMeters()){
                System.out.printf("%s es el más alto con una altura -> %.2f", persona1.getName(), persona1.getHeightMeters());
            } else {
                System.out.printf("%s es el más alto con una altura -> %.2f", persona3.getName(), persona3.getHeightMeters()); 
            }
        }else if (persona2.getHeightMeters() >= persona3.getHeightMeters()){
            System.out.printf("%s es el más alto con una altura -> %.2f", persona2.getName(), persona2.getHeightMeters()); 
        }else{
            System.out.printf("%s es el más alto con una altura -> %.2f", persona3.getName(), persona3.getHeightMeters()); 
        }
    }
